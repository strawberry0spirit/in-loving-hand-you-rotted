...
define config.name = _("in loving hands you rotted away")
...
define build.name = "inlovinghandsyourottedaway"
...
define config.save_directory = "inlovinghandsyourottedaway-1754371486"
